...
/*this class leverages some useful features from Picard <http://sourceforge.net/projects/picard/>
 * to quickly extract sequences from an indexed fasta file within given coordinates
 */
