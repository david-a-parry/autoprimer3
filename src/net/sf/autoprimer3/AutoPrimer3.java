...
import net.sf.autoprimer3.GeneDetails.Exon;
import static net.sf.autoprimer3.ReverseComplementDNA.reverseComplement;
...
public class AutoPrimer3 extends Application implements Initializable{
    ...
    public void start(final Stage primaryStage) {
        try {
            AnchorPane page = (AnchorPane) FXMLLoader.load(net.sf.autoprimer3.AutoPrimer3.class.getResource("AutoPrimer3.fxml"));
            Scene scene = new Scene(page);
            primaryStage.setScene(scene);
            primaryStage.setTitle("AutoPrimer3");
            scene.getStylesheets().add(net.sf.autoprimer3.AutoPrimer3.class.
    ...
    public void designPrimersToGene(){
        ...
        for (GenomicRegionSummary r : genomicRegions){
            ...
            for (GenomicRegionSummary er: exonRegions){
                ...
                p3_job.append(Integer.toString(flanks - designBuffer));
                p3_job.append(",");
                p3_job.append(Integer.toString(tEnd - tStart + 
                        (designBuffer * 2)));
                p3_job.append("\n");
                p3_job.append("SEQUENCE_ID=").append(er.getName()).
                        append(": ").append(er.getId()).append("\n");
                p3_job.append("SEQUENCE_TEMPLATE=").append(dnaTarget).append("\n");
                ...
                p3_job.append("PRIMER_THERMODYNAMIC_PARAMETERS_PATH=/home/david/Downloads/primer3-2.3.6/src/primer3_config/\n");
                p3_job.append("=");
